...
const centres = {
  1: ["75 Centennial Parkway North - Shoppers Drug Mart","75 Centennial Parkway North", "L8E 2P2", "Images/shoppers.png"],
  2: ["St. Joseph's Healthcare Hamilton - East End", "2757 King Street East", "L8G 5E4", "Images/joseph.png"]
}
...
const createUser = (request, response) => {
  ...
  const id =  Math.max.apply(null,Object.keys(obj)) + 1;
  users[id] = [name, code];
